...
namespace Rewards
{
    internal class DailyRewardView : MonoBehaviour
    {
        ...
        [field: SerializeField] public float TimeCooldownSeconds { get; private set; } = 86400;
        [field: SerializeField] public float TimeDeadlineSeconds { get; private set; } = 172800;
