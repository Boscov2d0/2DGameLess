    ...
    internal class DailyRewardController
    {
        ...
        private void RefreshRewardsState()
        {
            ...
            bool isDeadlineElapsed =
                timeFromLastRewardGetting.Seconds >= _view.TimeDeadlineSeconds;

            bool isTimeToGetNewReward =
                timeFromLastRewardGetting.Seconds >= _view.TimeCooldownSeconds;
        ...
        private string GetTimerNewRewardText()
        {
            ...
            {
                DateTime nextClaimTime = _view.TimeGetReward.Value.AddSeconds(_view.TimeCooldownSeconds);
        ...
        private void RefreshSlots()
        {
            for (var i = 0; i < _slots.Count; i++)
            {
                ...
                RewardPeriodType _periodType = _view.RewardPeriodType;

                _slots[i].SetData(reward, _periodType, countDay, isSelected);
            }
        }
    }
}
